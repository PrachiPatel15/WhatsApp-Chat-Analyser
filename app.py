...
if uploaded_file is not None:
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        fig,ax = plt.subplots()
        ax.plot(daily_timeline['Only Date'],daily_timeline["Messages"],color='black')
        plt.xticks(rotation='vertical')
        st.pyplot(fig)
        ...
        if selected_user == 'Overall':
            ...
            x, percentage_df = helper.most_busy_user(df)
            fig, ax = plt.subplots()
        ...
        # Most Used Emojis
        emoji_df = helper.analyse_emoji(selected_user,df)
